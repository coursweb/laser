...
![❌ Exemple problématique: cet élément a un *Fill* (rouge) et un *Stroke* (sans couleur mais présent).](images/fill-stroke-1.png)

![✅ Exemple correct: cet élément n'a pas de *Fill*, seulement un *Stroke* (rouge).](images/fill-stroke-2.png)
...
![❌ Dans cet exemple, il y a un problème car la sélection comporte des *Groupes* et *Cercles*. On aimerait n'avoir que des *Paths*.](images/inkscape-objects-selected.png)

![✅ Exemple correct: il n'y a que des *Paths*.](images/inkscape-selected-paths.png)
